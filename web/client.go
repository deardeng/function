...
func httpGet() {
	// 获取url请求
	resp, err := http.Get("http://album.zhenai.com/u/1359979340")
	if err != nil {
		panic(err)
	}
...
func clientHttpGet() {
	// 设置请求信息
	request, err := http.NewRequest(http.MethodGet, "http://www.zhenai.com/zhenghun/beijing", nil)
	if err != nil {
		panic(err)
	}
...
func clientStructGet() {
	// 设置请求信息
	request, err := http.NewRequest(http.MethodGet, "http://album.zhenai.com/u/1359979340", nil)
	if err != nil {
		panic(err)
	}
